...
def test_retrieval_receives_original_task(monkeypatch, fake_project_config):
    ...
    monkeypatch.setattr("context.retrieval.retrieve_context", fake_retrieve)
...
def test_forward_state_dir(monkeypatch, fake_project_config):
    ...
    monkeypatch.setattr("context.retrieval.retrieve_context", fake_retrieve)
    monkeypatch.setattr("orchestration.orchestration.ensure_project_index", lambda *a, **kw: None)
...
def test_index_lifecycle_happy_path(monkeypatch, fake_project_config):
    ...
    monkeypatch.setattr("orchestration.orchestration.ensure_project_index", lambda *a, **kw: calls.append("ensure"))
    monkeypatch.setattr("context.retrieval.retrieve_context", lambda **kw: calls.append("retrieve") or [])
    monkeypatch.setattr("orchestration.orchestration.delete_project_index", lambda *a, **kw: calls.append("delete"))
    monkeypatch.setattr("orchestration.orchestration.build_project_index", lambda *a, **kw: calls.append("build"))
...
def test_recovery_progress_messages(monkeypatch, fake_project_config):
    ...
    monkeypatch.setattr("orchestration.orchestration.ensure_project_index", lambda *a, **kw: None)
    monkeypatch.setattr("orchestration.orchestration.delete_project_index", lambda *a, **kw: None)
    monkeypatch.setattr("orchestration.orchestration.build_project_index", lambda *a, **kw: None)
