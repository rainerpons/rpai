...
import context.indexing.index
import context.retrieval.retrieve
context.indexing.index.get_default_embedding = lambda: MockEmbedding(embed_dim=2)
context.retrieval.retrieve.get_default_embedding = lambda: MockEmbedding(embed_dim=2)
